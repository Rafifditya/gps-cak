					...
					<div class="">
						<div class="row">
							<div class="col-md-12">
								<div class="x_panel">
									<div class="x_title">
										<h2><i class="fa fa-bars"></i> <b>Moving Overview</b></h2>
										<div class="clearfix"></div>
									</div>
									<div class="x_content">
										...
										<div class="" role="tabpanel" data-example-id="togglable-tabs">
											<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
												<li role="presentation" class="active"><a href="#tab_content1" id="list-tab" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <b>LIST DATA REPORT</b></a>
												</li>
											</ul>
                            ...
                            <div class="form-group">
                                ...
                                <label> Date : </label>
                                  ...
                                  <input type="text" name="mileage" class="form-control" placeholder="0" required>
                                  <label> L/KM </label>
                                  <input type="submit" value="check" class="btn btn-warning">
															...
															<div class="x_content">
																<div class="col-md-12">
														            ...
														            <div class="col-md-3 col-sm-5 col-xs-6 tile_stats_count">
														              <span class="count_top"><i class="fa fa-automobile"></i> Total Mileage (km) </span>
														              <div class="count">2500</div>
                                          <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>
														            </div>
														            <div class="col-md-3 col-sm-5 col-xs-6 tile_stats_count">
														              <span class="count_top"><i class="fa fa-map-marker"></i> Total Mileage </span>
														              <div class="count">123.50</div>
                                          <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>10% </i> From last Week</span>
														            </div>
														            <div class="col-md-3 col-sm-5 col-xs-6 tile_stats_count">
														              <span class="count_top"><i class="fa fa-dashboard"></i> Total Speeding [ Times ] </span>
														              <div class="count green">2,500</div>
                                          <span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>3% </i> From last Week</span>
														            </div>
														            <div class="col-md-3 col-sm-5 col-xs-6 tile_stats_count">
														              <span class="count_top"><i class="fa fa-cab"></i> Total Parking [ Times ] </span>
														              <div class="count">4,567</div>
                                          <span class="count_bottom"><i class="red">10% </i> From last Week</span>
														            </div>
																		...
																		<table id="datatable" class="table table-striped table-bordered">
																			<thead>
																				<tr>
																					...
																					<th class="text-center" style="vertical-align: middle;">Mileage (km)</th>
                                          <th class="text-center" style="vertical-align: middle;">Speeding (Times)</th>
                                          <th class="text-center" style="vertical-align: middle;">Parking (Times)</th>
                                          <th class="text-center" style="vertical-align: middle;">Fuel (L)</th>
																				</tr>
																			</thead>
																			<tbody>
																					<tr>
																						<td class="text-center" style="vertical-align: middle;">1</td>
																						<td class="text-center" style="vertical-align: middle;">Raspberry pi</td>
