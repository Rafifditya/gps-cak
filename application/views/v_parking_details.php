                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#tab_content1" id="list-tab"
                                                        ...
                                                        class="fa fa-list-alt"></i> <b>Parking Details</b></a>
                                        </li>
                                    </ul>
                                                                ...
                                                                <div class="form-inline">
                                                                    <div class="col-md-5">
                                                                        <div class="radio-inline">
                                                                            ...
                                                                            <div class="checkbox">
                                                                                <label>
                                                                                    <input type="checkbox"> remove drift
                                                                                    location
                                                                                </label>
                                                                            </div>
                                                                            <label>
                                                                ...
                                                                <div class="col-md-12 col-xs-12">
                                                                    <table id="datatable"
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th class="text-center"
                                                                                style="vertical-align: middle;">Start
                                                                                time
                                                                            </th>
                                                                            <th class="text-center"
                                                                                style="vertical-align: middle;">End Time
                                                                            </th>
                                                                            <th class="text-center"
                                                                                style="vertical-align: middle;">Stop
                                                                                duration
                                                                            </th>
                                                                            <th class="text-center"
