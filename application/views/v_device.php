                            ...
                            <div class="x_content">
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#tab_content1" id="list-tab" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <b> My Device </b></a>
                                        </li>
                                    </ul>
                                                            ...
                                                            <div class="col-md-12 col-xs-12">
                                                                <table id="datatable" class="table table-striped table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center" style="vertical-align: middle;">IMEI</th>
                                                                        <th class="text-center" style="vertical-align: middle;">SIM card</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Model</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Speeding value</th>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center" style="vertical-align: middle;">
                                                                            <a href="#">Detail</a> | <a href="#">Share location</a>
                                                                        </td>
