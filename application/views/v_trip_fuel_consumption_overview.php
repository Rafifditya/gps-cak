                            ...
                            <div class="x_content">
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#tab_content1" id="list-tab" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <b> Trip fuel consumption Overview</b></a>
                                        </li>
                                    </ul>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row tile_count">
                                                                    <div class="col-md-2 col-sm-3 col-xs-6 tile_stats_count">
                                                                        ...
                                                                        <div class="count"> <i class="fa fa-road"></i> 0</div>
                                                                        <span class="count_bottom"><i class="green">10%</i> From last Week</span>
                                                                    </div>
                                                                    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                                                                        <span class="count_top"> <b> Total Mileage </b> </span>
                                                                        <div class="count green"><i class="fa fa-map-marker"></i><i class="fa fa-car"></i> 0</div>
                                                                    ...
                                                                    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                                                                        ...
                                                                        <div class="count red"> <i class="fa fa-clock-o"></i> 0</div>
                                                                    ...
                                                                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                                        ...
                                                                        <div class="count"><i class="fa fa-tint"></i> 0</div>
                                                                    ...
                                                                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                                                        ...
                                                                        <div class="count"><i class="fa fa-fire"></i> 0</div>
                                                                        <span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>10% </i> From last Week</span>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-12 col-xs-12">
                                                                <table id="datatable" class="table table-striped table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center" style="vertical-align: middle;">Trip times</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Mileage</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Run time</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Fuel consumption (L)</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Average fuel consumption (L/100km)</th>
