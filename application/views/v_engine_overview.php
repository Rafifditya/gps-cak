									...
									<div class="x_content">
										...
										<div class="" role="tabpanel" data-example-id="togglable-tabs">
											<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
												<li role="presentation" class="active"><a href="#tab_content1" id="list-tab" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <b>Engine Overview</b></a>
												</li>
											</ul>
															...
															<div class="x_content">
																<div class="col-md-12">
														            ...
														            <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
														              ...
														              <div class="count"><i class="fa fa-car"></i> 0</div>
														            </div>
														            <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
														              <span class="count_top"><b> Total Engine ON </b></span>
														              <div class="count"><i class="fa fa-bolt"></i> 0</div>
														            </div>
														            <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
														              <span class="count_top"><b> Total Engine OFF </b></span>
														              <div class="count"><i class="fa fa-power-off"></i> 0</div>
														            </div>
																		...
																		<table id="datatable" class="table table-striped table-bordered">
																			<thead>
																				<tr>
																					...
																					<th class="text-center" style="vertical-align: middle;">Device quantity</th>
