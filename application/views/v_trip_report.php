								...
								<div class="x_panel">
									...
									<div class="x_content">
										...
										<div class="" role="tabpanel" data-example-id="togglable-tabs">
											<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
												<li role="presentation" class="active"><a href="#tab_content1" id="list-tab" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <b>Trip Report</b></a>
												</li>
											</ul>
                                    ...
                                    <label>
                                      ...
                                      <div class="checkbox">
                                        <label>
  																		<b>
                                      <input type="checkbox"> show GEOfence name</input>
  																		</b>
                                    </label>
                                    </div>
                                </div>
																		...
																		<table id="datatable" class="table table-striped table-bordered">
																			<thead>
																				<tr>
																					...
																					<th class="text-center" style="vertical-align: middle;">trip State</th>
																					<th class="text-center" style="vertical-align: middle;">Start time</th>
																					<th class="text-center" style="vertical-align: middle;">End time</th>
                                          ...
                                          <th class="text-center" style="vertical-align: middle;">Start location</th>
                                          <th class="text-center" style="vertical-align: middle;">End location</th>
