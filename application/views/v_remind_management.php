            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2><i class="fa fa-cogs"></i> <b> Remind Management </b></h2>
                                <div class="clearfix"></div>
                            </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1"
                                            ...
                                            <table id="datatable" class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center" style="vertical-align: middle;">Device
                                                        name
                                                    </th>
                                                    <th class="text-center" style="vertical-align: middle;">Item</th>
                                                    <th class="text-center" style="vertical-align: middle;">Expiration
                                                    </th>
                                                    <th class="text-center" style="vertical-align: middle;">Status</th>
                                                    <th class="text-center" style="vertical-align: middle;">Email</th>
                                                    <th class="text-center" style="vertical-align: middle;">Operation
                                                    </th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center" style="vertical-align: middle;">honda beat
                                                    </td>
                                                ...
                                                <div class="x_content">
                                                    <form action="http://localhost/audit/ms_audit_code/manage_audit_code/create"
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="control-label col-md-4">Expiration</label>
                                                                <div class="col-md-4">
