									...
									<div class="x_content">
										...
										<div class="" role="tabpanel" data-example-id="togglable-tabs">
											<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
												<li role="presentation" class="active"><a href="#tab_content1" id="list-tab" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <b> Driving behavior Overview</b></a>
												</li>
											</ul>
											<div id="myTabContent" class="tab-content">
												<!-- search TAB -->
												<div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="list-tab">
													<?php
													echo form_open();
													?>
																		...
																		<div class="radio-inline">
																		  <label>
																		    <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">
																				Periode Details | Date :
																		  </label>
																		</div>
																	<input type="text" name="visit_date" id="visit_date_edit" class="form-control" placeholder="e.g. 12-08-2018 - 21-08-2018" required>
															...
															<div class="x_content">
																<div class="col-md-12">
														            ...
														            <div class="col-md-2 col-sm-3 col-xs-6 tile_stats_count">
														              <span class="count_top"> <b> Total Fatigue Driving </b> </span>
														              <div class="count"> <i class="fa fa-frown-o"></i> 0</div>
																					<span class="count_bottom"><i class="green">10%</i> From last Week</span>
														            </div>
														            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
														              <span class="count_top"> <b> Total Harsh driving accelerate</b> </span>
														              <div class="count green"><i class="fa fa-level-up"></i><i class="fa fa-car"></i> 0</div>
																					<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>7% </i> From last Week</span>
														            </div>
														            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
														              <span class="count_top"> <b> Total Harsh driving braking </b></span>
														              <div class="count red"> <i class="fa fa-level-down"></i><i class="fa fa-car"></i> 0</div>
																					<span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>3% </i> From last Week</span>
														            </div>
														            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
														              <span class="count_top"> <b>Total Sharp Turn</b> </span>
														              <div class="count"><i class="fa fa-mail-reply"></i><i class="fa fa-car"></i> 0</div>
																					<span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>10% </i> From last Week</span>
														            </div>
																				<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
														              <span class="count_top"> <b>Total Sharp change Lane</b> </span>
														              <div class="count"><i class="fa fa-random"></i> 0</div>
																					<span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>10% </i> From last Week</span>
														            </div>
																		...
																		<table id="datatable" class="table table-striped table-bordered">
																			<thead>
																				<tr>
																					...
																					<th class="text-center" style="vertical-align: middle;">Fatigue Driving</th>
																					<th class="text-center" style="vertical-align: middle;">Harsh driving acceleration</th>
																					<th class="text-center" style="vertical-align: middle;">Hars driving braking</th>
																					<th class="text-center" style="vertical-align: middle;">Sharp turn</th>
																					<th class="text-center" style="vertical-align: middle;">Sharp Change lane</th>
																			...
																			<tbody>
																					<tr>
																						...
																						<td class="text-center" style="vertical-align: middle;">Motor honda Beat</td>
