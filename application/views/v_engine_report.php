							...
							<div class="col-md-12">
								<div class="x_panel">
									...
									<div class="x_content">
										...
										<div class="" role="tabpanel" data-example-id="togglable-tabs">
											<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
												<li role="presentation" class="active"><a href="#tab_content1" id="list-tab" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <b>Engine Report</b></a>
												</li>
											</ul>
                                  ...
                                  <label>
																		<b>
                                    Filter :
                                    <input type="checkbox" > Engine ON </input>
                                    |
                                      <input type="checkbox" > Engine OFF </input>
																		</b>
																	</label>
                                </div>
                                </div>
															...
															<div class="form-group">
																<div class="row tile_count">
																		<div class="col-md-5 col-sm-5 col-xs-6 tile_stats_count">
																			<span class="count_top"> <b>Engine ON</b> </span>
																			<div class="count"><i class="fa fa-bolt"></i> 0</div>
																		</div>
																		<div class="col-md-5 col-sm-5 col-xs-6 tile_stats_count">
																			<span class="count_top"><b>	Engine OFF</b> </span>
																		...
																		<table id="datatable" class="table table-striped table-bordered">
																			<thead>
																				<tr>
																					...
																					<th class="text-center" style="vertical-align: middle;">GPS time</th>
																					<th class="text-center" style="vertical-align: middle;">ACC</th>
