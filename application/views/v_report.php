									...
									<div class="x_content">
										...
										<div class="" role="tabpanel" data-example-id="togglable-tabs">
											<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
												<li role="presentation" class="active"><a href="#tab_content1" id="list-tab" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <b> Moving Overview</b></a>
												</li>
											</ul>
															...
															<div class="x_content">
																<div class="col-md-12">
														            ...
														            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
														              ...
														              <div class="count"> <i class="fa fa-automobile"></i> 2500</div>
														            ...
														            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
														              ...
														              <div class="count red"> <i class="fa fa-dashboard"></i> 2,500 </div>
														            ...
														            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
														              ...
														              <div class="count"><i class="fa fa-cab"></i> 4,567</div>
