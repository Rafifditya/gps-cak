															...
															<div class="x_content">
																<div class="col-md-12">
														            ...
														            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
														              <span class="count_top"><i class="fa fa-automobile"></i> Device Quantity </span>
																		...
																		<table id="datatable" class="table table-striped table-bordered">
																			<thead>
																				<tr>
																					...
																					<th class="text-center" style="vertical-align: middle;">Total Speeding(Times)</th>
																					<th class="text-center" style="vertical-align: middle;">Total Parking(Times)</th>
																				</tr>
																			</thead>
																			<tbody>
																					<tr>
