                            ...
                            <div class="x_content">
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#tab_content1" id="list-tab" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <b> Alert Overview</b></a>
                                        </li>
                                    </ul>
                                                            ...
                                                            <div class="col-md-12 col-xs-12">
                                                                <table id="datatable" class="table table-striped table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center" style="vertical-align: middle;">Vibration</th>
                                                                        <th class="text-center" style="vertical-align: middle;">External power disconnect</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Low Battery</th>
                                                                        <th class="text-center" style="vertical-align: middle;">SOS</th>
                                                                        <th class="text-center" style="vertical-align: middle;">GEOfence out</th>
                                                                        <th class="text-center" style="vertical-align: middle;">GEOfence in</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Speeding</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Towing</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Engine ON</th>
                                                                        <th class="text-center" style="vertical-align: middle;">Engine OFF</th>
