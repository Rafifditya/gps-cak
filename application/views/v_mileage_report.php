									...
									<div class="x_content">
										...
										<div class="" role="tabpanel" data-example-id="togglable-tabs">
											<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
												<li role="presentation" class="active"><a href="#tab_content1" id="list-tab" role="tab" data-toggle="tab"><i class="fa fa-list-alt"></i> <b>Mileage Report</b></a>
												</li>
											</ul>
															...
															<div class="form-group">
																<div class="row tile_count">
																		<div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
																			...
																			<div class="count"> <i class="fa fa-map-marker"></i> 0</div>
																		</div>
																		<div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
																			<span class="count_top"> <b> Total Speeding (Times) </b> </span>
																			<div class="count"><i class="fa fa-tachometer"></i> 12</div>
																		</div>
																		<div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
																			<span class="count_top"> <b>Total Parking [ Times ] </b> </span>
																			<div class="count"> <i class="fa fa-cab"></i> 0 </div>
																		</div>
																		<div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
																			<span class="count_top"> <b>Total fuel</b> </span>
																			<div class="count"><i class="fa fa-tint"></i> 4,2 L</div>
																		</div>
